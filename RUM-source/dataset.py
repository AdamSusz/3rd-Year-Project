...
def cifar10withids_dataloaders(
    ...
    data_dir = data_dir + '/cifar10'
    train_set = CIFAR10WithID(root=data_dir, train=True, download=True, transform=train_transform)
    test_set  = CIFAR10WithID(root=data_dir, train=False, download=True, transform=test_transform)
...
def cifar100withids_dataloaders(
    ...
    data_dir = data_dir + '/cifar100'
    train_set = CIFAR100WithID(root=data_dir, train=True, download=True, transform=train_transform)
    test_set  = CIFAR100WithID(root=data_dir, train=False, download=True, transform=test_transform)
