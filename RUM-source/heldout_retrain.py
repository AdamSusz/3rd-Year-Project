...
def main():
        ...
        if args.mem_proxy is not None:
            if args.unlearn_step == 1:
                ...
                if args.unlearn == 'seq_mix':
                    ...
                    filename_rt = (f'{args.unlearn}_{args.dataset}_{args.arch}_{args.class_to_replace}_num{args.num_indexes_to_replace}_'
                               f'groupid{args.group_index}_proxy{args.mem_proxy}_{args.mem}_step{args.unlearn_step-1}_seed{args.seed}.pth.tar')
                               #heldout_retrain_cifar10_vgg16_bn_lth_SCRUB_step1_num3000_groupidNone_proxyho_ret_mix_s1374
    ...
    else: #heldout_retrain_cifar10_vgg16_bn_lth_SCRUB_step1_num3000_groupidNone_proxyho_ret_mix_s1374.npz
