...
def main():
    ...
    df_final = df_final.assign(dataset=args.dataset, arch=args.arch, proxy=args.mem_proxy, unlearn_step=args.unlearn_step)
    #
    fname = os.path.join(args.save_dir, "0result_tow.csv")
