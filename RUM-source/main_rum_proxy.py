...
def main():
    ...
    runs = [
        ...
        f"python3.10 main_forget.py --seed {seed} --no_aug --sequential --mem_proxy {proxy} --mem low --unlearn {unlearn} --unlearn_step {unlearn_step} --alpha 0.99 --unlearn_epochs 10 --unlearn_lr 0.01 --num_indexes_to_replace {num_indexes_to_replace} --class_to_replace {class_to_replace} --dataset {dataset} --arch {arch} --data {data} --epochs {epochs} --lr {lr} --decreasing_lr {decreasing_lr} --batch_size {batch_size} --mask {original_model_path} --wandb-mode offline --beta {beta} --gamma {gamma} --msteps {mstep} --kd_T 4.0",
        f"python3.10 main_forget.py --seed {seed} --no_aug --sequential --mem_proxy {proxy} --mem mid --unlearn {unlearn} --unlearn_step {unlearn_step} --alpha 0.97 --unlearn_epochs 10 --unlearn_lr 0.01 --num_indexes_to_replace {num_indexes_to_replace} --class_to_replace {class_to_replace} --dataset {dataset} --arch {arch} --data {data} --epochs {epochs} --lr {lr} --decreasing_lr {decreasing_lr} --batch_size {batch_size} --mask {low_step_model_path} --wandb-mode offline --beta {beta} --gamma {gamma} --msteps {mstep} --kd_T 4.0" ,
        f"python3.10 main_forget.py --seed {seed} --no_aug --sequential --mem_proxy {proxy} --mem high --unlearn {unlearn} --unlearn_step {unlearn_step} --alpha 0.97 --unlearn_epochs 10 --unlearn_lr 0.001 --num_indexes_to_replace {num_indexes_to_replace} --class_to_replace {class_to_replace} --dataset {dataset} --arch {arch} --data {data} --epochs {epochs} --lr {lr} --decreasing_lr {decreasing_lr} --batch_size {batch_size} --mask {mid_step_model_path} --wandb-mode offline --beta {beta} --gamma {gamma} --msteps {mstep} --kd_T 4.0",
        # Evaluation
        f"python3.10 main_forget.py --seed {seed} --no_aug --unlearn seq_mix --unlearn_step {unlearn_step} --mem_proxy {proxy} --mem mix --num_indexes_to_replace 3000 --class_to_replace {class_to_replace} --dataset {dataset} --arch {arch} --data {data} --epochs {epochs} --lr {lr} --decreasing_lr {decreasing_lr} --batch_size {batch_size} --mask {high_step_model_path} --wandb-mode offline"
     ]
